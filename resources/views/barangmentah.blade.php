<table class="min-w-full w-full text-gray-700">
    ...
    <tbody>
        <tr class="border-b hover:bg-green-50 transition">
            ...
            <td class="p-4 text-center">BRG001</td>
            <td class="p-4 text-center">Benang Jahit</td>
            <td class="p-4 text-center">Benang</td>
            <td class="p-4 text-center">100</td>
            <td class="p-4 text-center font-semibold text-green-600">Tersedia</td>
        ...
        <tr class="border-b hover:bg-green-50 transition">
            ...
            <td class="p-4 text-center">BRG002</td>
            <td class="p-4 text-center">Kancing Putih</td>
            <td class="p-4 text-center">Kancing</td>
